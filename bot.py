...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    welcome_text = f"""
🎨 **Welcome to ImageGenie_ProBot, {user.first_name}!**

I'm your AI image generator. Send me a text description, and I'll create an image!
...
**Styles:** Realistic, Anime, Digital Art, Oil Painting, Watercolor, Cartoon, Cyberpunk, Fantasy, Minimalist, Sketch

**Sizes:** Square (1024x1024), Portrait (768x1024), Landscape (1024x768), Wide (1280x720)
...
def main() -> None:
    ...
    try:
        ...
        # Start the Bot
        logger.info("🚀 ImageGenie_ProBot started successfully!")
